                                ...
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" value="<?php echo $student['nama']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="nim">NIM</label>
                                            <input type="text" name="nim" class="form-control" value="<?php echo $student['nim']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="angkatan" class="form-control" value="<?php echo $student['angkatan']; ?>" required>
                                        </div>
